...
export default function ResultPage() {
  ...
  return (
    <RetroPage
      reportTitle="期待値報告書"
      commands={[
        { label: '戻る', onClick: () => router.push('/calculation') },
    ...
    >
      ...
      <div className="grid gap-2 sm:grid-cols-2">
        <RetroButton onClick={() => router.push('/calculation')}>再計算する</RetroButton>
        <RetroButton onClick={() => router.push('/')}>ホームに戻る</RetroButton>
      </div>
