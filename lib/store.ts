...
import type { AppSettings, HistoryEntry, CalculationResult } from '@/types';
import { DEFAULT_SETTINGS } from '@/types';

const SETTINGS_KEY = 'slot-compass:settings';
const HISTORY_KEY = 'slot-compass:history';
const RECENT_MACHINE_KEY = 'slot-compass:recent-machine';
const CURRENT_RESULT_KEY = 'slot-compass:current-result';
